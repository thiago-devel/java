package br.com.rubyit.resseler.persistence.config1.dao;
...
/**
 * Configuration class instead application-context.xml to config String context.
 *
 * @author a42239
 *
 */
...
public class SalesDAOAppConfig {

	public static final String PERSISTENCE_UNIT_NAME_RESSELER = "Resseler";
    public static final String RESSELER_JNDI_NAME = "java:jboss/datasources/Resseler";
    public final String[] ENTITY_PKG_SCANNING = {
            "br.com.rubyit.resseler.core.persistence.dao.entity" };

    /*
    @Bean
    public EntityLoggerDAO retrieveEntityLoggerDAO() {
        return new EntityLoggerDAO();
    }

    @Bean
    public EntityKeyParamDAO retrieveEntityKeyParamDAO() {
        return new EntityKeyParamDAO();
    }

    @Bean
    public EntityKeyDAO retrieveEntityKeyDAO() {
        return new EntityKeyDAO();
    }

    @Bean
    public EntityParameterDAO retrieveEntityParameterDAO() {
        return new EntityParameterDAO();
    }

    @Bean
    public EntityKeyValueLoggerDAO retrieveEntityKeyValueLoggerDAO() {
        return new EntityKeyValueLoggerDAO();
    }
    */
