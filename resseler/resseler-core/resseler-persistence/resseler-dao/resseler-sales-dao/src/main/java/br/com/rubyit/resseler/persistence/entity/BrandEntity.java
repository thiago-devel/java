...
@Entity
@Table(uniqueConstraints = {@UniqueConstraint(columnNames = "ID", name = "CNT_BRAND_ID_UNIQUE")})
public class BrandEntity extends BaseEntity implements Identificable, Describable {
